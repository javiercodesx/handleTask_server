...
export class AuthEmail {
    ...
    static sendConfirmationEmail = async (user: IEmail) => {
        await transporter.sendMail({
            ...
            text: `Hello ${user.name}, you've created your Facebook account, almost everything is ready, you just need to confirm your account. This token will expire in 10 minutes.`,
            html: `
                <!DOCTYPE html>
                <html>
                <head>
    ...
    static sendResetPasswordEmail = async (user: IEmail) => {
        await transporter.sendMail({
            from: 'handleTask <admin@handleTask.com>',
            to: user.email,
            subject: 'handleTask - Reset your password',
            ...
            <body>
                <div class="email-container">
                    ...
                    <div class="content">
                        ...
                        <p><strong>Important:</strong> This token will expire in <strong>10 minutes</strong>.</p>
                    </div>
                    <div class="footer">
                        <p>&copy; ${new Date().getFullYear()} handleTask. All rights reserved.</p>
                    </div>
